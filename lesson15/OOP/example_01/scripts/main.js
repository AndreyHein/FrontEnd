...
const Homer = new HumanNew('Homer', 'Simpson', 15);
const Sponge = new HumanNew('SpongeBob', 'SquarePants', 30);
console.log(Homer);
console.log(Homer.walk == Sponge.walk);
console.log(diffInAge(Homer, Sponge));
...
const Mila = new ActorNew('Mila', 'J', 25, 'USA');